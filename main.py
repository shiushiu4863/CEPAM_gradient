...
if __name__ == '__main__':
    ...
    os.makedirs('results_tradeoff_gaussian', exist_ok=True)
    os.makedirs('results_tradeoff_laplace', exist_ok=True)
    os.makedirs('results_fl', exist_ok=True)

    results_file = f'results_fl/{args.model}_{args.baseline}_{args.privacy_type}_{args.seed}_{args.lattice_dim}_{args.sigma}.txt'
    ...
    if args.baseline == 'cepam':
        if args.privacy_type == 'gaussian':
            results_file = f'results_testing_gaussian_0.01/{args.model}_{args.baseline}_{args.privacy_type}_{args.seed}_{args.lattice_dim}_{args.sigma}.txt'
        else:
        ...
        if args.privacy_type == 'gaussian':
            results_file = f'results_testing_gaussian_0.01/{args.model}_{args.baseline}_{args.privacy_type}_{args.seed}_{args.sigma}.txt'
        else:
